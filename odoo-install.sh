#!/bin/bash
################################################################################
# Script for installing Odoo on Ubuntu 14.04 and 16.04
# Author: Yenthe Van Ginneken , Mahmoud Naguib Abou Zamil
#-------------------------------------------------------------------------------
...
echo "-----------------------------------------------------------"
echo "------Nginx checks / installation------"
...
sudo cat <<EOF > /etc/nginx/conf.d/$OE_USER.conf
    server {
